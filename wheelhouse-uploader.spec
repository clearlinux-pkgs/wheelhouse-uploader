...
Source0  : https://files.pythonhosted.org/packages/fb/bc/cb89b6fbe418b89495372b81da6a35cd78de1eb4f61d773bb724127166a6/wheelhouse-uploader-0.10.3.tar.gz
...
%prep
%setup -q -n wheelhouse-uploader-0.10.3
cd %{_builddir}/wheelhouse-uploader-0.10.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596555878
